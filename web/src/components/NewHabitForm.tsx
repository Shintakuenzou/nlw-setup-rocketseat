...
export function NewHabitForm() {
  ...
  async function createNewHabit(event: FormEvent) {
    //Evita Redirecionamento do Usuário
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <input
        ...
        type="text"
        id="title"
        placeholder="EX: Execícios, Dormir 8h, etc..."
        autoFocus
        value={title}
      ...
      <div className="flex flex-col gap-2 mt-3">
        {AVAILABL_EWEEK_DAYS.map((weekDay, i) => {
          return (
            <CheckBox.Root
              key={weekDay}
            ...
            >
              ...
              <span className="text-white leading-tight font-normal">
                {weekDay}
              </span>
            </CheckBox.Root>
          );
